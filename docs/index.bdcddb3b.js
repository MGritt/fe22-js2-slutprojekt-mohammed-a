 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Nc{constructor(e,t,n,r,s){this.snapshotVersion=e,this.targetChanges=t,this.targetMismatches=n,this.documentUpdates=r,this.resolvedLimboDocuments=s}static createSynthesizedRemoteEventForCurrentChange(e,t,n){const r=new Map;return r.set(e,Dc.createSynthesizedTargetChangeForCurrentChange(e,t,n)),new Nc(Ai.min(),r,qa(),Da(),Va())}}class Dc{constructor(e,t,n,r,s){this.resumeToken=e,this.current=t,this.addedDocuments=n,this.modifiedDocuments=r,this.removedDocuments=s}static createSynthesizedTargetChangeForCurrentChange(e,t,n){return new Dc(n,t,Va(),Va(),Va())}}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Cu{constructor(){this.overlays=new eo(Li.comparator),this.ts=new Map}getOverlay(e,t){return ji.resolve(this.overlays.get(t))}getOverlays(e,t){const n=Pa();return ji.forEach(t,(t=>this.getOverlay(e,t).next((e=>{null!==e&&n.set(t,e)})))).next((()=>n))}saveOverlays(e,t,n){return n.forEach(((n,r)=>{this.re(e,t,r)})),ji.resolve()}removeOverlaysForBatchId(e,t,n){const r=this.ts.get(n);return void 0!==r&&(r.forEach((e=>this.overlays=this.overlays.remove(e))),this.ts.delete(n)),ji.resolve()}getOverlaysForCollection(e,t,n){const r=Pa(),s=t.length+1,i=new Li(t.child("")),o=this.overlays.getIteratorFrom(i);for(;o.hasNext();){const e=o.getNext().value,i=e.getKey();if(!t.isPrefixOf(i.path))break;i.path.length===s&&e.largestBatchId>n&&r.set(e.getKey(),e)}return ji.resolve(r)}getOverlaysForCollectionGroup(e,t,n,r){let s=new eo(((e,t)=>e-t));const i=this.overlays.getIterator();for(;i.hasNext();){const e=i.getNext().value;if(e.getKey().getCollectionGroup()===t&&e.largestBatchId>n){let t=s.get(e.largestBatchId);null===t&&(t=Pa(),s=s.insert(e.largestBatchId,t)),t.set(e.getKey(),e)}}const o=Pa(),a=s.getIterator();for(;a.hasNext()&&(a.getNext().value.forEach(((e,t)=>o.set(e,t))),!(o.size()>=r)););return ji.resolve(o)}re(e,t,n){const r=this.overlays.get(n.key);if(null!==r){const e=this.ts.get(r.largestBatchId).delete(n.key);this.ts.set(r.largestBatchId,e)}this.overlays=this.overlays.insert(n.key,new Ec(t,n));let s=this.ts.get(t);void 0===s&&(s=Va(),this.ts.set(t,s)),this.ts.set(t,s.add(n.key))}}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Du{constructor(e){this.Ts=e,this.docs=new eo(Li.comparator),this.size=0}setIndexManager(e){this.indexManager=e}addEntry(e,t){const n=t.key,r=this.docs.get(n),s=r?r.size:0,i=this.Ts(t);return this.docs=this.docs.insert(n,{document:t.mutableCopy(),size:i}),this.size+=i-s,this.indexManager.addToCollectionParentIndex(e,n.path.popLast())}removeEntry(e){const t=this.docs.get(e);t&&(this.docs=this.docs.remove(e),this.size-=t.size)}getEntry(e,t){const n=this.docs.get(t);return ji.resolve(n?n.document.mutableCopy():xo.newInvalidDocument(t))}getEntries(e,t){let n=Da();return t.forEach((e=>{const t=this.docs.get(e);n=n.insert(e,t?t.document.mutableCopy():xo.newInvalidDocument(e))})),ji.resolve(n)}getDocumentsMatchingQuery(e,t,n,r){let s=Da();const i=t.path,o=new Li(i.child("")),a=this.docs.getIteratorFrom(o);for(;a.hasNext();){const{key:e,value:{document:o}}=a.getNext();if(!i.isPrefixOf(e.path))break;e.path.length>i.length+1||Fi(xi(o),n)<=0||(r.has(o.key)||_a(t,o))&&(s=s.insert(o.key,o.mutableCopy()))}return ji.resolve(s)}getAllFromCollectionGroup(e,t,n,r){ui()}Es(e,t){return ji.forEach(this.docs,(e=>t(e)))}newChangeBuffer(e){return new Ru(this)}getSize(e){return ji.resolve(this.size)}}class Ru extends Tu{constructor(e){super(),this.Jn=e}applyChanges(e){const t=[];return this.changes.forEach(((n,r)=>{r.isValidDocument()?t.push(this.Jn.addEntry(e,r)):this.Jn.removeEntry(n)})),ji.waitFor(t)}getFromCache(e,t){return this.Jn.getEntry(e,t)}getAllFromCache(e,t){return this.Jn.getEntries(e,t)}}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Ou{constructor(e){this.persistence=e,this.As=new Aa((e=>aa(e)),ca),this.lastRemoteSnapshotVersion=Ai.min(),this.highestTargetId=0,this.Rs=0,this.vs=new ku,this.targetCount=0,this.bs=Eu.vn()}forEachTarget(e,t){return this.As.forEach(((e,n)=>t(n))),ji.resolve()}getLastRemoteSnapshotVersion(e){return ji.resolve(this.lastRemoteSnapshotVersion)}getHighestSequenceNumber(e){return ji.resolve(this.Rs)}allocateTargetId(e){return this.highestTargetId=this.bs.next(),ji.resolve(this.highestTargetId)}setTargetsMetadata(e,t,n){return n&&(this.lastRemoteSnapshotVersion=n),t>this.Rs&&(this.Rs=t),ji.resolve()}Sn(e){this.As.set(e.target,e);const t=e.targetId;t>this.highestTargetId&&(this.bs=new Eu(t),this.highestTargetId=t),e.sequenceNumber>this.Rs&&(this.Rs=e.sequenceNumber)}addTargetData(e,t){return this.Sn(t),this.targetCount+=1,ji.resolve()}updateTargetData(e,t){return this.Sn(t),ji.resolve()}removeTargetData(e,t){return this.As.delete(t.target),this.vs.hs(t.targetId),this.targetCount-=1,ji.resolve()}removeTargets(e,t,n){let r=0;const s=[];return this.As.forEach(((i,o)=>{o.sequenceNumber<=t&&null===n.get(o.targetId)&&(this.As.delete(i),s.push(this.removeMatchingKeysForTargetId(e,o.targetId)),r++)})),ji.waitFor(s).next((()=>r))}getTargetCount(e){return ji.resolve(this.targetCount)}getTargetData(e,t){const n=this.As.get(t)||null;return ji.resolve(n)}addMatchingKeys(e,t,n){return this.vs.os(t,n),ji.resolve()}removeMatchingKeys(e,t,n){this.vs.cs(t,n);const r=this.persistence.referenceDelegate,s=[];return r&&t.forEach((t=>{s.push(r.markPotentiallyOrphaned(e,t))})),ji.waitFor(s)}removeMatchingKeysForTargetId(e,t){return this.vs.hs(t),ji.resolve()}getMatchingKeysForTargetId(e,t){const n=this.vs.fs(t);return ji.resolve(n)}containsKey(e,t){return ji.resolve(this.vs.containsKey(t))}}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * limitations under the License.
 */
function Zf(e,t=[]){let n;switch(e){case"Browser":n=jf(N());break;case"Worker":n=`${jf(N())}-${e}`;break;default:n=e}const r=t.length?t.join(","):"FirebaseCore-web";return`${n}/JsCore/${Me}/${r}`}
/**
 * @license
 * Copyright 2022 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */qp.receivers=[];class $p{constructor(e){this.target=e,this.handlers=new Set}removeMessageHandler(e){e.messageChannel&&(e.messageChannel.port1.removeEventListener("message",e.onMessage),e.messageChannel.port1.close()),this.handlers.delete(e)}async _send(e,t,n=50){const r="undefined"!=typeof MessageChannel?new MessageChannel:null;if(!r)throw new Error("connection_unavailable");let s,i;return new Promise(((o,a)=>{const c=jp("",20);r.port1.start();const u=setTimeout((()=>{a(new Error("unsupported_event"))}),n);i={messageChannel:r,onMessage(e){const t=e;if(t.data.eventId===c)switch(t.data.status){case"ack":clearTimeout(u),s=setTimeout((()=>{a(new Error("timeout"))}),3e3);break;case"done":clearTimeout(s),o(t.data.response);break;default:clearTimeout(u),clearTimeout(s),a(new Error("invalid_response"))}}},this.handlers.add(i),r.port1.addEventListener("message",i.onMessage),this.target.postMessage({eventType:e,eventId:c,data:t},[r.port2])})).finally((()=>{i&&this.removeMessageHandler(i)}))}}
/**
 * @license
 * Copyright 2020 Google LLC
 *
